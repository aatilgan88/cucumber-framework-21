...
//    =======click on hotelmanagement, room reservation, addroom reservation
    ...
    public void user_enters_the_contact_phone() {
        roomReservationPage.contactPhone.sendKeys("4058614799");
    }
...
//        select.selectByVisibleText("manager");
    ...
    public void user_enters_all_required_fields(DataTable roomData) {
        ...
        System.out.println(testData);//[manager, Sierra, 500, 08/01/2021, 08/04/2021, 2, 3, John, 9999999999, test.gmail.com, test]
        Select select=new Select(roomReservationPage.idUser);
