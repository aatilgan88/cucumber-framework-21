  ...
  Scenario:TC01_user_should_be_able_to_login_with_manager_profile
    ...
    Then capture the screenshot
      ...
      Scenario: TC02_user_should_be_able_to_make_reservation
        ...
        |IDUser|IDHotel|price|date_start|date_end|adult_amount|children_name|contact_name|contact_phone|contact_email|notes|
        ...
        And user verifies the success_message
        Then capture the screenshot
